...
export default function Kemerdekaan({ diam }: { diam: boolean }) {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      ...
      >
        <div className="flex items-start origin-left scale-[0.52] sm:scale-75 lg:scale-100">
          <Pesawat diam={diam} />

          {/* ---------- tali penarik ---------- */}
          <svg width="86" height="120" viewBox="0 0 86 120" className="-ml-1 mt-[26px] flex-shrink-0">
            {/* Melengkung turun: benda yang ditarik tertinggal dan menggantung. */}
            <path
              d="M0 6 Q 46 10 84 34"
          ...
          >
            <div className="relative w-full h-full flex">
              ...
              <span className="absolute right-0 inset-y-0 w-3 bg-gradient-to-l from-black/15 to-transparent" />
            </div>
          </div>
        </div>
      </motion.div>
