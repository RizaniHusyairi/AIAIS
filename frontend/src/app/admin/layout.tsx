...
import { THEME_INIT_SCRIPT, setAdminTheme, useAdminTheme } from '@/components/admin/theme';
...
import {
  ...
  CalendarClock, DoorOpen, Radio, FileBarChart, Globe, ClipboardList, Users, UserCircle, HelpCircle, MapPin, BarChart3, CalendarRange, Wallet, School, BadgeCheck, Gavel, HardHat,
...
/**
 * Penyetel tema sebelum halaman digambar.
 *
 * Dirender sebagai <script> sebaris supaya peramban menjalankannya saat
 * mengurai HTML — jauh sebelum React hidrasi. Kalau ditunda sampai efek,
 * pengguna tema gelap disambut kedipan putih di tiap pemuatan.
 */
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  if (isPublik) return <><ThemeScript />{children}</>;
